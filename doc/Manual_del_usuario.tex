...
Esta seccion esta destinada a proporcionar información sobre las funcionalidades
...
mostrará la pantalla de GRUB. Se puede presionar
enter para proceder, o de lo contrario GRUB continuará la carga del sistema tras un
número prestablecido de segundos, visible en el ultimo renglón de la pantalla. Una vez realizado 
el booteo, se cargará el shell. A partir de
aquí se puede comenzar a utilizar los comandos provistos por el shell.
...
\subsubsection{isodd}
Informa si el número ingresado es par o impar.
