...
que tiene un puntero a función y el nombre del comando. El maximo tamaño de un comando son 
...
según el keypress de las teclas $CTRL$ y $ALT$. Cuando se aprieta el $BLOCK MAYUS$ se activa una
...
el sistema se reinicia, mandando un valor determinado a cierta dirección del teclado.

\subsection{IN-OUT}
Tenemos un vector de diez lugares en los cuales estan los distintos tipos de $in-out$. En la
primera posición del vector ($index = 0$) esta el standard $in$ y en la segunda posicióm el standard
$out$
