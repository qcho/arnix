...
mediante la cual se hace un paso desde el userspace al kernel space para utilizar algunos codigós.
...
\subsection{Shell}
El maximo tamaño de un comando son 1000 caracteres.
si te pasas ignora los las siguitenes entradas.
al inicial se agregan todas los comandos, esto se hace utilizando una estructura 
que tiene un puntero a función y el nombre del comando.
Cada 500 caracteres se hace un flush del stream y no te permite borrar los 500 caracteres
anteriores. Elimina los espacios del principio y del final y los espacios multiples 
entre medio de distintos argumentos. Se puede ingresar un argumento entre comillas para 
que no lo divida por espacios demas. A diferencia de las shells que normalmente 
utilizamos (Unix/Linux) elimina los espacios repetidos y no permite poner enters 
...
se logró dividiendo en diferentes carpetas los distintos archivos relacionados con cada espacio.
...
no todas las opciones estan en ella. Las opciones del printf que se hicieron son las más
